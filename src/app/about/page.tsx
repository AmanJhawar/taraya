...
export default function About() {
  return (
    <div className="pt-16 pb-24 min-h-screen bg-off-white selection:bg-black selection:text-white">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <StaggerContainer className="flex flex-col items-center justify-center space-y-16 md:space-y-20">
          ...
          <FadeInUp className="w-full text-center">
            <p className="font-garamond font-normal text-xs uppercase tracking-[0.3em] text-gray-400 mb-6 md:mb-8">
              Our Heritage
            </p>
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-serif font-medium text-black leading-[1.25] tracking-tight max-w-3xl mx-auto">
          ...
          <FadeInUp className="w-full max-w-xl text-left space-y-8">
            <p className="text-lg md:text-xl text-gray-700 font-garamond font-light leading-relaxed">
          ...
          {/* Second Block */}
          <FadeInUp className="w-full max-w-xl text-left space-y-8">
            <p className="text-lg md:text-xl text-gray-700 font-garamond font-normal leading-relaxed">
          ...
          <FadeInUp className="w-full max-w-3xl text-center pt-4">
            <h2 className="text-2xl md:text-4xl font-serif font-medium text-black leading-[1.3] tracking-tight">
          ...
          <FadeInUp className="w-full flex flex-col items-center text-center space-y-12 pt-4">
            <p className="text-lg md:text-xl text-gray-700 font-garamond font-normal leading-relaxed text-left max-w-xl">
