  ...
  return (
    <button
      ...
      className={cn(
        ...
        'transition-[background-color,color,border-color,transform] duration-150 ease-[var(--ease-out)]',
        ...
        active 
          ...
          : 'bg-transparent text-ink border border-line hover:border-ink/30 active:scale-[0.97]',
        className
      )}
      {...props}
    />
